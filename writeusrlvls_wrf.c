...
_________________________________________________________________________
    ...
    This function prints height or pressure level based output to appropriate files.  
    Input data are taken from soundings generated from WRF output. 
*/
...
int writeusrlvl(struct sound *user, char *outpath)
{
  ...
  /* Open output file.  ************************************/
   ...
   /*   USER DEFINED level output ***********************/
    ...
    fprintf(fuseroutl,"USER DEFINED LEVEL OUTPUT (MODEL)\n\n");
    ...
    fprintf(fuseroutl,"          (m)      (degrees)      (kn)          (K)      (hPa)        (K)\n\n");
